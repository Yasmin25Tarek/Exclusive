            ...
            <NavigationMenuList>
              {links.map((link, idx) =>
                <NavigationMenuItem key={idx}>
                  <NavigationMenuLink
                    href={link.path}
                    className={cn(navigationMenuTriggerStyle(), pathName === link.path && "text-red-500")}>
                    {link.label}
                  </NavigationMenuLink>
                </NavigationMenuItem>
              )}
            ...
            <SheetContent side="top" className="max-h-screen overflow-auto">
              ...
              <div className="flex flex-col p-4">
                <div className="flex flex-col gap-6">
                  {links.map((link, idx) =>
                    <Link key={idx} href={link.path} className={cn("font-medium", pathName === link.path && "text-red-500")}>
                      {link.label}
                    </Link>
